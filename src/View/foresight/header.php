<section class="header w-100">
    <div id="header1" class="w-100 header-shadow header-wrapper">
        <div class="header-nav flex justify-between items-center">
            ...
            <div id="site-menu" class="nav-menu dn flex-ns justify-end items-center fw7">
                <a href="/tematy" class="nav-link flex items-center">scenariusze</a>
                <a href="http://horyzontyprzyszlosci.pl/" target="_blank" class="nav-link flex items-center">o projekcie</a>
                <?php if ($edit_mode): ?>
                <?php /*<div class="drawer-trigger nav-link flex items-center pointer">+ scenariusz</div> */ ?>
...
<div id="drawer-right" class="mm-ocd mm-ocd--right drawer-close">
    ...
    <div class="w-drawer">
        ...
        <h3 class="ma0 lh-solid">utwórz scenariusz</h3>
        <form method="post" action="" class="pv5">
            ...
            <div class="w-100 mv4 mt5-l"><button id="new-submit" class="matter-button-contained w-100 big-rnd big-btn">utwórz scenariusz</button></div>
